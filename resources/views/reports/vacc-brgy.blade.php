                                        ...
                                        <div class="row hidden-print">
                                            <div class="col-md-12">
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="form-control brgy-select" name="owner" required onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                                                                <option value="/reports/vacc/0">See All</option>
                                                                @foreach($brgys as $brgy)
                                                                    <option value="/reports/vacc/{{ $brgy->id }}" @if($brgyI->id == $brgy->id) selected @endif>Brgy. {{ $brgy->name }}</option>
                                                                @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="pull-right">
                                                    ...
                                                    <a target="_blank" href="/reports/form/{{ $brgyI->id }}" class="btn btn-inverse waves-effect waves-light"><i class="fa fa-print"></i> Print Vaccination Form</a>
                                                </div>
                                            </div>
                                        </div>
